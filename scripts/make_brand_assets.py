...
def make_banner(png: Path, svg: Path, title: str, subtitle: str,
    ...
    x_text = 0.34 * width
    ax.text(x_text, 0.72 * height, title, color=TITLE, fontsize=40,
...
if __name__ == "__main__":
    make_icon(ASSETS / "icon.png", ASSETS / "icon.svg")
    make_banner(
        ASSETS / "banner.png", ASSETS / "banner.svg",
        title="NO-COMBUSTION CAES",
        subtitle="AD, LTA and LTAHP: three fuel-free concepts on one basis",
        note="reject the heat, store it in water, or sell it - screened per kilogram of air",
    )
